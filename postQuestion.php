...
if($_POST && !empty($_POST['topic']) && !empty($_POST['content']) && !empty($_POST['category'])) {
  $msg = $forum->post_question($_POST['topic'], $_POST['content'], $_POST['category']);
}
      ...
      <div id="content">
        ...
        <div id="post">
          ...
          <form method="post" action="" class="question">
            ...
            <?php $forum->category_dropdown(); ?> <br/>
